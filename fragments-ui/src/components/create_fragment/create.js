...
export default function Create({ user }) {
  ...
  return (
    <div className="">
      <h1 className="text-3xl text-center pb-6">Create a fragment (only supports text/plain)</h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-2/3 space-y-6">
          ...
          />
          <Button type="submit" variant="outline" className="bg-white text-black">Submit</Button>
        </form>
      </Form>
    </div>
  );
