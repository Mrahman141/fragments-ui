    ...
    return <>
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          <div
            className="w-16 h-16 border-4 border-dashed rounded-full animate-spin border-[#ffffff] mx-auto"
          ></div>
          <h2 className="text-white mt-4">Loading...</h2>
          <p className="text-slate-400">
            Your data is being retrieved. Please wait. Thank you for your patience!
          </p>
        </div>
      </div>
    </>;
              ...
              <div>
                <Tabs defaultValue="account" className="pt-12">
                  <div className="flex justify-center">
                    <TabsList>
                      <TabsTrigger value="create">Create a Fragment</TabsTrigger>
                    </TabsList>
                  </div>
                  <TabsContent value="list" className="text-white">Make changes to your account here.</TabsContent>
                  <TabsContent value="create" className="text-white pt-10"> <Create user={user}/> </TabsContent>
                </Tabs>
              </div>
            </>
          )}
